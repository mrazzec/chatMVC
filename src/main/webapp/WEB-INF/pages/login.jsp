...
<nav class="navbar navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <c:if test="${sessionScope.currentUser != null}">
                <li class="nav-item">
                    <a id="nav-link" class="nav-link" href="${pageContext.request.contextPath}/user">Кабинет</a>
                </li>
                <li class="nav-item">
...
<div class="container w-25">
    <div class="row">
        <form action="${pageContext.request.contextPath}/log" method="post">
            <input class="form-control form-control-sm" type="text" name="login" placeholder="Ваш логин">
            <input class="form-control form-control-sm" type="password" name="password" placeholder="Ваш пароль">
