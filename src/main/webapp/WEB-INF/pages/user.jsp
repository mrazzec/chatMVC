...
<div class="container w-25">
    <div class="row">
        <form action="${pageContext.request.contextPath}/user" method="post">
            <input class="form-control form-control-sm" type="hidden" name="id" value="${requestScope.user.id}">
            <p>Ваш логин</p>
            <input class="form-control form-control-sm" type="text" name="login" value="${requestScope.user.login}">
            <p>Ваше имя</p>
            <input class="form-control form-control-sm" type="text" name="name" value="${requestScope.user.name}">
            <input class="form-control form-control-sm" type="hidden" name="password" value="${requestScope.user.password}">
